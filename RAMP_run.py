...
charging_mode = 'Perfect Foresight' # Select charging mode (Uncontrolled', 'Night Charge', 'RES Integration', 'Perfect Foresight')
...
try:
    inputfile_residual_load = r"Input_data\Residual Load duration curve\residual_load_IT.csv"
