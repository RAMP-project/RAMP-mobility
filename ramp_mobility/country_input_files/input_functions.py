# -*- coding: utf-8 -*-
from core_model.core import User
import numpy as np
import pandas as pd
import copy
'''
Functions necessary to define common input data, load and process country-dependant data from database and finally create Users objects 
'''
#%% Defining common input values
def common_inputs(country):
    #Variabilities 
    ...
    return P_var, r_d, r_v, r_w, occasional_use, Par_P_EV, Battery_cap, country_equivalent
#%% Country-dependant files with inputs to be loaded 
def data_loading(inputfolder, country_equivalent):
...
#%% Processing and rearranging imported data
def data_processing(country, country_equivalent, pop_data, vehicle_data, d_tot_data, d_min_data, t_func_data, window_data, trips):
    ...
    return pop_sh, vehicle_sh, d_tot, d_min, t_func, window, perc_usage
#%% Creating Users and Appliance objects
def creating_users(User_list, tot_users, pop_sh, vehicle_sh, Par_P_EV, Battery_cap, P_var, d_tot, perc_usage, r_d, t_func, r_v, d_min, occasional_use, window, r_w):
    '''
    Function that generates Users and related Appliances starting from input files 
    '''    
    #%% Definition of Users 
    '''
    Users
    ...
    '''
    Function that generate Appliances
    '''
    # Working 
